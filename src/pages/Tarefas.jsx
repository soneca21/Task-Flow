  ...
  return (
    <>
      ...
      <div className="space-y-3">
        <div className="grid grid-cols-2 gap-2 lg:flex lg:flex-row lg:gap-4 lg:flex-wrap">
          <div className="relative col-span-2 lg:col-span-1 lg:flex-1 min-w-[200px]">
          ...
          <Select value={filterStatus} onValueChange={setFilterStatus}>
            <SelectTrigger className="w-full lg:w-44 bg-card/60 border-border text-foreground h-9 text-xs lg:h-12 lg:text-sm">
