...
('logistica_expedicao_retirar', 'Expedicao e Retira', 'logistica', null, '#3b82f6', true, 1),
...
('apoio_aux_servicos_gerais', 'Auxiliar de Servicos Gerais', 'apoio_operacional', null, '#64748b', true, 1),
('mov_ponte_rolante', 'Operador de Ponte Rolante', 'movimentacao_carga', null, '#22c55e', true, 1),
('mov_portico', 'Operador de Portico', 'movimentacao_carga', null, '#22c55e', true, 2),
...
('prod_dobra_vergalhao', 'Dobra de Vergalhao', 'producao', null, '#eab308', true, 7)
